...
[FFFFFF]📱 CONTACT: [FFFF00]@NoTmeowL
[00FF00]»»————-　★　————-««
...
[b][i][FFA500]telegram: @NoTmeowL[/b]

[b][c][FFA500]telegram contact: @NoTmeowL[A52A2A]
...
#==================≈===========  /HELP MENU COMMANDS ========================================
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "hello", "hi"):
                            ...
                            header = f"[C][B][FF1493]Hey User Welcome To [00FFAA]NoTmeowL's BOT"
